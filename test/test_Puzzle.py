...
from src.Algorithm import AStar
from src.Heuristic import MisplacedTile
from src.Heuristic import EuclideanDistance
...
class TestSample(unittest.TestCase):
    ...
    def test_AStar_MisplacedTile(self):
        initial_states = [
            State([[1,2,3],[4,5,6],[7,8,0]]), # Depth 0
            State([[1,2,3],[4,5,0],[7,8,6]]), # Depth 1
            State([[1,2,3],[4,5,6],[7,0,8]]), # Depth 1
    ...
    def test_AStar_EuclideanDistance(self):
        initial_states = [
            State([[1,2,3],[4,5,6],[7,8,0]]), # Depth 0
            State([[1,2,3],[4,5,0],[7,8,6]]), # Depth 1
            State([[1,2,3],[4,5,6],[7,0,8]]), # Depth 1
            ...
            State([[0,4,1],[7,5,2],[8,6,3]]), # Depth 12
            State([[7,4,1],[8,5,2],[0,6,3]]), # Depth 14
            State([[0,7,4],[8,5,1],[6,3,2]])  # Depth 20
        ]
        depths = [0,1,1,2,4,8,12,14, 20]
        goal = State([[1,2,3],[4,5,6],[7,8,0]])
        problems = []

        ucs = AStar(EuclideanDistance())
